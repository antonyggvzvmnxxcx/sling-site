...
def slingApplication=[
  ...
  "Sling Feature Model Launcher|A tool for launching OSGi applications|org.apache.sling.feature.launcher|.zip|1.3.4|Y",
...
def mavenPlugins=[
  ...
  "Maven Enforcer Rules|maven-enforcer-rules|1.2.0|Y",
]
...
def bundles=[
  ...
  "Bundle Resource Provider|org.apache.sling.bundleresource.impl|3.0.0|Y|jar",
  ...
  "CMS App API|org.apache.sling.cms.api|1.1.8|org.apache.sling.app.cms|jar",
  "CMS App Archetype|org.apache.sling.cms.archetype|1.1.8|org.apache.sling.app.cms|jar",
  "CMS App Core|org.apache.sling.cms.core|1.1.8|org.apache.sling.app.cms|jar",
  "CMS App Integration Tests|org.apache.sling.cms.it|1.1.8|org.apache.sling.app.cms|jar",
  "CMS App Login|org.apache.sling.cms.login|1.1.8|org.apache.sling.app.cms|jar",
  "CMS App Reference|org.apache.sling.cms.reference|1.1.8|org.apache.sling.app.cms|jar",
  "CMS App Transformer|org.apache.sling.cms.transformer|1.1.8|org.apache.sling.app.cms|jar",
  "CMS App UI|org.apache.sling.cms.ui|1.1.8|org.apache.sling.app.cms|jar",
  ...
  "Commons FileSystem ClassLoader|org.apache.sling.commons.fsclassloader|2.0.0|Y|jar",
  "Commons HTML|org.apache.sling.commons.html|1.1.0|Y|jar",
  "Commons Johnzon|org.apache.sling.commons.johnzon|2.0.0|Y|jar",
  "Commons Log|org.apache.sling.commons.log|6.1.0|Y|jar",
  ...
  "Commons Metrics|org.apache.sling.commons.metrics|2.0.0|Y|jar",
  ...
  "Commons Mime Type Service|org.apache.sling.commons.mime|3.0.0|Y|jar",
  "Commons OSGi|org.apache.sling.commons.osgi|2.4.2|Y|jar",
  "Commons Scheduler|org.apache.sling.commons.scheduler|2.7.14|Y|jar",
  "Commons Testing|org.apache.sling.commons.testing|2.2.2|Y|jar",
  ...
  "Discovery API|org.apache.sling.discovery.api|1.0.6|Y|jar",
  "Discovery Impl|org.apache.sling.discovery.impl|1.2.12|Y|jar",
  "Discovery Commons|org.apache.sling.discovery.commons|1.1.0|Y|jar",
  "Discovery Base|org.apache.sling.discovery.base|2.1.0|Y|jar",
  "Discovery Oak|org.apache.sling.discovery.oak|1.2.48|Y|jar",
  "Discovery Standalone|org.apache.sling.discovery.standalone|1.0.4|Y|jar",
  "Discovery Support|org.apache.sling.discovery.support|1.0.8|Y|jar",
  "Distributed Event Admin|org.apache.sling.event.dea|1.1.6|Y|jar",
  "Distribution API|org.apache.sling.distribution.api|0.7.2|Y|jar",
  "Distribution Core|org.apache.sling.distribution.core|0.7.4|Y|jar",
  ...
  "Distribution Journal Core|org.apache.sling.distribution.journal|0.5.0|Y|jar",
  "Distribution Journal Messages|org.apache.sling.distribution.journal.messages|0.5.12|Y|jar",
  ...
  "Engine|org.apache.sling.engine|3.0.2|Y|jar",
  "Event|org.apache.sling.event|4.4.2|Y|jar",
  ...
  "Feature Model Analyser|org.apache.sling.feature.analyser|2.0.18|Y|jar",
  "Feature Model Converter|org.apache.sling.feature.modelconverter|1.0.14|Y|jar",
  "Feature Model Content Package Converter|org.apache.sling.feature.cpconverter|1.3.10|Y|jar",
  "Feature Model Extension API Regions|org.apache.sling.feature.extension.apiregions|2.2.0|Y|jar",
  "Feature Model Content Extension|org.apache.sling.feature.extension.content|1.0.18|Y|jar",
  ...
  "GraphQL Schema Aggregator|org.apache.sling.graphql.schema.aggregator|0.0.4|Y|jar",
  ...
  "JCR Content Loader|org.apache.sling.jcr.contentloader|3.0.0|Y|jar",
  ...
  "JUnit Core|org.apache.sling.junit.core|1.3.0|Y|jar",
  ...
  "Launchpad Base - Application Launcher|org.apache.sling.launchpad.base|7.0.5-2.8.2|Y|war",
  ...
  "Resource Resolver|org.apache.sling.resourceresolver|1.12.18|Y|jar",
  "Resource Resolver|org.apache.sling.resourceresolver|2.0.6|Y|jar",
  "Rewriter|org.apache.sling.rewriter|1.4.4|Y|jar",
  ...
  "Scripting API|org.apache.sling.scripting.api|2.2.2|Y|jar",
  "Scripting SPI|org.apache.sling.scripting.spi|2.0.0|Y|jar",
  ...
  "Scripting Core|org.apache.sling.scripting.core|3.0.2|Y|jar",
  ...
  "Scripting JSP|org.apache.sling.scripting.jsp|2.6.2|Y|jar",
  "Scripting JSP API Wrapper|org.apache.sling.scripting.jsp-api|1.0.2|Y|jar",
  "Scripting JSP Taglib|org.apache.sling.scripting.jsp.taglib|2.4.2|Y|jar",
  "Scripting FreeMarker|org.apache.sling.scripting.freemarker|1.0.4|Y|jar",
  "Scripting Groovy|org.apache.sling.scripting.groovy|1.3.0|Y|jar",
  ...
  "Scripting HTL Engine|org.apache.sling.scripting.sightly|2.0.0-1.4.0|Y|jar",
  "Scripting HTL JS Use Provider|org.apache.sling.scripting.sightly.js.provider|1.2.14|Y|jar",
  "Scripting HTL Sling Models Use Provider|org.apache.sling.scripting.sightly.models.provider|1.0.10|Y|jar",
  ...
  "Security|org.apache.sling.security|1.3.2|Y|jar",
  ...
  "Sling Query|org.apache.sling.query|4.0.4|Y|jar",
  "Starter Content|org.apache.sling.starter.content|2.0.2|Y|jar",
  "Starter Integration Tests|org.apache.sling.starter.integration-tests|14|Y|jar",
  "Starter Testing Services|org.apache.sling.starter.test-services|14|Y|jar",
  ...
  "Validation API|org.apache.sling.validation.api|1.0.2|Y|jar",
  "Validation Core|org.apache.sling.validation.core|1.0.4|Y|jar",
  "Web Console Branding|org.apache.sling.extensions.webconsolebranding|1.0.4|Y|jar",
  "Web Console Security Provider|org.apache.sling.extensions.webconsolesecurityprovider|2.0.0|Y|jar",
...
def helpers=[
  ...
  "Project Archetype|sling-project-archetype|1.0.16|Y|jar",
  ...
  "Testing OSGi Mock JUnit 5|org.apache.sling.testing.osgi-mock.junit5|3.5.8|org.apache.sling.testing.osgi-mock|jar",
  ...
  "Testing Sling Mock Core|org.apache.sling.testing.sling-mock.core|4.0.6|org.apache.sling.testing.sling-mock|jar",
  "Testing Sling Mock JUnit 4|org.apache.sling.testing.sling-mock.junit4|4.0.6|org.apache.sling.testing.sling-mock|jar",
  "Testing Sling Mock JUnit 5|org.apache.sling.testing.sling-mock.junit5|4.0.6|org.apache.sling.testing.sling-mock|jar",
  "Testing Sling Mock Oak|org.apache.sling.testing.sling-mock-oak|4.1.0-1.86.0|Y|jar",
]
...
def deprecated=[
  ...
  "Commons JSON|Replaced with Commons Johnzon|org.apache.sling.commons.json|2.0.28",
  "Crankstart API|Use OSGi Feature Model instead|org.apache.sling.crankstart.api|1.0.0|jar",
  "Crankstart API Fragment|Use OSGi Feature Model instead|org.apache.sling.crankstart.api.fragment|1.0.2",
  "Crankstart Core|Use OSGi Feature Model instead|org.apache.sling.crankstart.core|1.0.0",
  "Crankstart Launcher|Use OSGi Feature Model instead|org.apache.sling.crankstart.launcher|1.0.0",
  "Crankstart Launcher Sling Extensions|Use OSGi Feature Model instead|org.apache.sling.crankstart.sling.extensions|1.0.0",
  "Crankstart Launcher Test Services|Use OSGi Feature Model instead|org.apache.sling.crankstart.test.services|1.0.0",
  ...
  "Health Check JUnit Bridge|Migrated to Apache Felix Health Checks|org.apache.sling.hc.junit.bridge|1.0.2",
  ...
  "Launchpad Integration Tests|org.apache.sling.launchpad.integration-tests|13|Y|jar",
  "Launchpad Test Fragment Bundle||org.apache.sling.launchpad.test-fragment|12",
  "Launchpad Testing Services|org.apache.sling.launchpad.test-services|13|Y|jar",
  "Launchpad Testing Services WAR||org.apache.sling.launchpad.test-services-war|2.0.16",
